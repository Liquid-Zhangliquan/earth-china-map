...
THREE.GLTFLoader = (function () {
	...
	function replaceTHREEShaderAttributes(shaderText, technique) {
		...
		for (var attributeId in technique.attributes) {
			...
			var attrName = technique.attributes[attributeId];

			var param = technique.parameters[attrName];
		...
		for (var attributeId in attributes) {
			...
			var attrName = shaderAttributes[attributeId];
			var shaderParam = shaderParams[attrName];
